      ...
      >
        ...
        >
          ...
          <div class="sidebar-brand-text mx-3 badge badge-light">
            <font color="#5899D5">UNI</font><font color="#2C4381">ESTOQUE</font>
          </div>
        </a>
        ...
        <!-- Heading -->
        <div class="sidebar-heading">Fluxo</div>
          ...
          <div class="container-fluid">
            ...
            <div class="row">
              ...
              <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-left-success shadow h-100 h-50 py-2">
                  <div class="card-body">
                  ...
                  <div
                    class="card-footer h-25 bg-transparent border-0 align-items-center"
                  >
                    <p class="badge bg-light text-muted d-flex text-center">
                      <small
                        >Colocar popover explicativo ao clicar no icone</small
                      >
                    </p>
                  </div>
                </div>
                ...
                <div class="card shadow mb-4">
                  ...
                  <div class="card-body">
                    ...
                    <div class="mt-4 text-center small">
                      <span class="mr-2">
                        <i class="fas fa-circle text-primary"></i> Perecíveis
                      </span>
                      <span class="mr-2">
                        <i class="fas fa-circle text-success"></i> Bebidas
                      </span>
                      <span class="mr-2">
                        <i class="fas fa-circle text-info"></i> Descartáveis
                      </span>
                    </div>
                  </div>
                </div>
        ...
        <footer class="sticky-footer bg-white">
          <div class="container my-auto">
            <div class="copyright text-center my-auto">
              <span>Copyright &copy; UNIEstoque</span>
            </div>
          </div>
        </footer>
        <!-- End of Footer -->
